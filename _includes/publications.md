...
<li>
  <div class="pub-row">
    ...
    <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
      ...
      <a href="https://arxiv.org/abs/2405.16005" class="btn btn-sm z-depth-3" role="button" target="_blank" style="font-size:16px;">paper</a>
      <a href="https://github.com/adreamwu/PTQ4DiT" class="btn btn-sm z-depth-3" role="button" target="_blank" style="font-size:16px;">Code</a>
